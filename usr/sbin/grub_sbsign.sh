...
"lsefimmap lsefisystab lssal memdisk minicmd normal ntfs part_apple part_msdos "\
"part_gpt password_pbkdf2 png probe reboot regexp search search_fs_uuid "\
"search_fs_file search_label sleep smbios squash4 test true video xfs zfs "\
"zfscrypt zfsinfo cpuid play tpm cryptodisk gcry_arcfour gcry_blowfish "\
"gcry_camellia gcry_cast5 gcry_crc gcry_des gcry_dsa gcry_idea gcry_md4 gcry_md5 "\
"gcry_rfc2268 gcry_rijndael gcry_rmd160 gcry_rsa gcry_seed gcry_serpent gcry_sha1 "\
"gcry_sha256 gcry_sha512 gcry_tiger gcry_twofish gcry_whirlpool luks lvm mdraid09 "\

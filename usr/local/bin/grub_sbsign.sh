...
"efinet ext2 fat font gettext gfxmenu gfxterm gfxterm_background gzio halt "\
"help hfsplus iso9660 jpeg keystatus loadenv loopback linux ls lsefi lsefimmap "\
...
"cpuid play	tpm cryptodisk gcry_arcfour gcry_blowfish gcry_camellia gcry_cast5 "\
...
"gcry_sha256 gcry_sha512 gcry_tiger gcry_twofish gcry_whirlpool luks lvm "\
"mdraid09 mdraid1x raid5rec raid6rec http tftp"
